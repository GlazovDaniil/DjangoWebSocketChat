...
SECRET_KEY = 'django-insecure-!7seyr=_=^ego&)f9v&8qox!)ou4t55z9naos4w^129w)t(ao%'
...
CHANNELS_REDIS_PORT = os.getenv('CHANNELS_REDIS_PORT', 6379)

CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels_redis.core.RedisChannelLayer',
        'CONFIG': {
            "hosts": [f"redis://{CHANNELS_REDIS_HOST}:{CHANNELS_REDIS_PORT}/3"],  # ['127.0.0.1', '6379'],
        },
    },
}
